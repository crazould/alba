  ...
  return <ul className="grid md:grid-cols-3 gap-8 mb-8">
    {portfolios.map(({thumbnail, type, title, desc}, idx) => (
      <li key={idx} className="group cursor-pointer">
        ...
        <div className="pt-5 pl-5 pb-10 pr-10 text-sm border-x border-b border-zinc-300 group-hover:border-[var(--accent-color)] rounded-b-xl md:min-h-[313px] lg:min-h-[205px] duration-200">
